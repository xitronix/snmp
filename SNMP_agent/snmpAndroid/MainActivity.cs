...
namespace snmpAndroid
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            udpServer = new UdpClient(11001);
            endPoint = new IPEndPoint(IPAddress.Any, 11001);
            endPointSend = new IPEndPoint(IPAddress.Parse("192.168.42.209"), 11000);
        }
        ...
        private void Btn_Click2(object sender, EventArgs e)
        {
            ...
            var client = new UdpClient();
            client.Connect(endPointSend);
            byte[] msg = Encoding.ASCII.GetBytes(editText.Text);
            int size = Encoding.ASCII.GetByteCount(oid);
